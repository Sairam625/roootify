...
const Auth = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
            <div className={`relative bg-white rounded-2xl shadow-2xl overflow-hidden max-w-4xl w-full min-h-[600px] transition-all duration-300 ${isSignUp ? 'right-panel-active' : ''}`} id="container">
                ...
                <div className="absolute top-0 h-full transition-all duration-600 ease-in-out left-0 w-1/2 opacity-0 sign-up-container">
                    <form onSubmit={handleSignup} className="bg-white flex flex-col items-center justify-center h-full px-12 text-center">
                        ...
                        <div className="social-container mb-4">
                            <span className="text-gray-500 text-sm">Use your email for registration</span>
                        </div>
                        ...
                        <div className="relative w-full mb-4">
                            ...
                            <input
                                type="text"
                                placeholder="Name"
                                className="bg-gray-100 border-none p-3 pl-10 rounded-lg w-full outline-none focus:ring-2 focus:ring-primary"
                                value={signupName}
                        ...
                        <div className="relative w-full mb-6">
                            <select
                                ...
                                className="bg-gray-100 border-none p-3 rounded-lg w-full outline-none focus:ring-2 focus:ring-primary text-gray-600"
                            >
                ...
                <div className="absolute top-0 h-full transition-all duration-600 ease-in-out left-0 w-1/2 sign-in-container">
                    <form onSubmit={handleLogin} className="bg-white flex flex-col items-center justify-center h-full px-12 text-center">
                        ...
                        <div className="social-container mb-4">
                            <span className="text-gray-500 text-sm">Use your account</span>
                        </div>
                ...
                <div className="absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-transform duration-600 ease-in-out z-100 overlay-container">
                    <div className="bg-gradient-to-r from-primary to-green-400 text-white relative -left-full h-full w-[200%] transform transition-transform duration-600 ease-in-out overlay">
